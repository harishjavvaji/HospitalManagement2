...
<%--<form class="form-horizontal" action="/searchDoctor" method="post">--%>
    ...
    <%--<div class="form-group">--%>
        <%--<label class="control-label col-sm-2" for="docName">Enter Doctor Name:</label>--%>
        <%--<div class="col-xs-4">--%>
            <%--<input type="text" class="form-control" id="docName" name="docName" placeholder="Search for Doctor">--%>
        <%--</div>--%>
    <%--</div>--%>
